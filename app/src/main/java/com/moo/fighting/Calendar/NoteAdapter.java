...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder> {
    ...
    private void SettingData(){
        ...
        appData = context.getSharedPreferences("date_info",Context.MODE_PRIVATE);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView){
            ...
            checkBox.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(view.getContext(),"계획 완료!",Toast.LENGTH_SHORT).show();
                }
            });
            ...
            deleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    editor.remove(TODO.substring(1,11));
                    editor.commit();
                    String Date = TODO.substring(15);
                    deleteToDo(Date);
        ...
        public void setItem(Note item){
            checkBox.setText("["+item.getDate_todo()+"]   " + item.getTodo());
        }
